        ...
        <ul className="timeline-with-icons">
          <li className="timeline-item mb-5">
            ...
            <h5 className="fw-bold">
              ...
              <span className="badge text-bg-info">Latest</span>
            </h5>
            <p className="text-muted mb-2 fw-bold">July 2025 - Present</p>
          ...
          <li className="timeline-item mb-5">
            ...
            <p className="text-muted mb-2 fw-bold">24 June 2020 (Part-Time)</p>
            <p className="text-muted">
